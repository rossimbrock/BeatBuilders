...
export default function SongCard({songTitle, songArtist} : {songTitle:any, songArtist:any}) {
    return (
        <div className="flex-col w-1/2 justify-center justify-items-center">
            <div className="border-2 border-purple-300 px-3 py-3 rounded-lg shadow-lg w-full"> 
                ...
                <p className = "text-2xl font-semibold pt-2"> {songTitle} </p>
                <p className = "font-extralight font-lg"> {songArtist} </p>
            </div>
